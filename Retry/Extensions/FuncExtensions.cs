...
namespace Retry
{
    public static class FuncExcensions
    {
        ...
        public static ITryAndReturnValue<TResult> Try<T1, T2, TResult>(this Func<T1, T2, TResult> func, T1 arg1, T2 arg2, int retries)
        {
            return TryIt.Try(func, arg1, arg2, retries);
        }


        public static ITryAndReturnValue<TResult> Try<T1, T2, T3, TResult>(this Func<T1, T2, T3, TResult> func, T1 arg1, T2 arg2, T3 arg3, int retries)
        {
            return TryIt.Try(func, arg1, arg2, arg3, retries);
        }

        public static ITryAndReturnValue<TResult> Try<T1, T2, T3, T4, TResult>(this Func<T1, T2, T3, T4, TResult> func, T1 arg1, T2 arg2, T3 arg3, T4 arg4, int retries)
        {
