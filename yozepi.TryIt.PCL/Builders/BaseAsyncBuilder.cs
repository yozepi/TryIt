...
{
    public class BaseAsyncBuilder: BaseBuilder
    {

        protected internal virtual async Task RunAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                while (runnerLink != null)
                {
                    ...
                    var runner = runnerLink.Value as BaseAsyncRunner;
